# How to Enter Purchase Data with Common Duties & Taxes

Source: https://taxone.vyapar.com/help/articles/purchase-data-common-duties-taxes

[All Collection](/help)[Frequently Asked Question](/help/collections/faqs)[How to Enter Purchase Data with Common Duties & Taxes](/help/articles/purchase-data-common-duties-taxes)
...
Upload purchase bills with the same tax ledger using Suvit. Map GST, duties & taxes easily and save format for future uploads.

### Single Taxable Rate with Common SGST/CGST/IGST (Duties & Taxes)

If your entry looks like the image below, or if you want to enter a similar type of entry, where each purchase bill has the same **DUTIES & TAXES ledger**, you can do so. This can be for either a **single bill with a single entry or a single bill with multiple entries**, all having the **same TAX RATES**.
![1 sample main.png](https://strapi.suvit.io/uploads/1_sample_main_67622f4957.png)
![11.png](https://strapi.suvit.io/uploads/11_f754a8fb95.png)

\*\*Data requirement for excel sheet\*\*

![2 excel sample.png](https://strapi.suvit.io/uploads/2\_excel\_sample\_f9c1f45fe0.png)
...
![3  mapping.png](https://strapi.suvit.io/uploads/3_mapping_eef77d4d0d.png)
...
![4 gst mapping1.png](https://strapi.suvit.io/uploads/4_gst_mapping1_882cb8667c.png)
...
![2 gst mapping1.png](https://strapi.suvit.io/uploads/2_gst_mapping1_6b184862d0.png)
