# Purchase Bill: Single Tax Rate with Common GST Ledger

Source: https://taxone.vyapar.com/help/articles/purchase-with-item-single-tax-rate-common-gst

[All Collection](/help)[Frequently Asked Question](/help/collections/faqs)[Purchase Bill: Single Tax Rate with Common GST Ledger](/help/articles/purchase-with-item-single-tax-rate-common-gst)

[Purchase bill With Item - Single Tax Rate - Common GST (Duties & Taxes)](#purchase-bill-with-item-single-tax-rate-common-gst-duties-taxes-)[How to upload an Excel sheet:Click Here](#how-to-upload-an-excel-sheet-click-here)[Mapping](#mapping)[Step 1: Field Mapping](#step-1-field-mapping)[Step 2: GST Mapping (Map Your Tax Ledger)](#step-2-gst-mapping-map-your-tax-ledger-)[How to pick Duties & Taxes amounts from the Excel sheet:](#how-to-pick-duties-taxes-amounts-from-the-excel-sheet-)[Step 3: Ledger Mapping](#step-3-ledger-mapping)

# Purchase Bill: Single Tax Rate with Common GST Ledger

Manage Purchase bills with same tax rate and common GST ledger in Suvit. Follow step-by-step Excel upload and mapping to streamline your data entry process.

#### Purchase bill With Item - Single Tax Rate - Common GST (Duties & Taxes)
...
![2.png](https://strapi.suvit.io/uploads/2\_e86052740b.png)
...
![4.png](https://strapi.suvit.io/uploads/4_9d7fa0ffd7.png)
...
![5.png](https://strapi.suvit.io/uploads/5_16b8275eaa.png)

--- OR ---

![6.png](https://strapi.suvit.io/uploads/6\_2dcd308b63.png)
...
![7.png](https://strapi.suvit.io/uploads/7_4d5b40851b.png)
