# Handle Multi Tax & GST Ledgers with Stock Items in Suvit

Source: https://taxone.vyapar.com/help/articles/with-item-multiple-tax-rates-multiple-duties-and-taxes

[All Collection](/help)[Frequently Asked Question](/help/collections/faqs)[Handle Multi Tax & GST Ledgers with Stock Items in Suvit](/help/articles/with-item-multiple-tax-rates-multiple-duties-and-taxes)
...
Manage bills with multiple items and tax rates using GST ledgers in Suvit. Follow our step-by-step guide to upload, map Excel data, and sync with Tally.
...
* A bill with a **single or multiple tax rates**, using the **different/multiple** GST ledger **(Duties & Taxes)**.
  ![1 sample entry.png](https://strapi.suvit.io/uploads/1_sample_entry_8df14323c3.png)

\*\*Data requirement for excel sheet\*\*

![2 sample sheet.png](https://strapi.suvit.io/uploads/2\_sample\_sheet\_c17c22c3cb.png)
...
* \*\*B\*\* → By using filter in \*\*GST TAX RATE\*\* or in \*\*SALES Account\*\* name put \*\*DUTIES & TAXES name\*\* respectively as shown in the above image. (All three fields are compulsory so if IGST is not applicable, kindly create IGST in Tally)
...
#### How to upload an Excel sheet: <a href="https://help.suvit.io/articles/uploading-sales-sales-return-data-through-an-excel-sheet"target="\_blank">Click Here
...
![3 gst mapping.png](https://strapi.suvit.io/uploads/3_gst_mapping_7fa7cf4a9a.png)
...
![4 mnaual calculation.png](https://strapi.suvit.io/uploads/4_mnaual_calculation_3d09eaafa4.png)
